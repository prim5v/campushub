...
def delete_property(current_user_id, role, property_id, *args, **kwargs):
    response = remove_property(current_user_id, role, property_id, *args, **kwargs)  # call module function that handles DB
    return response